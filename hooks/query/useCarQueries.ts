...
export const useCarBrands = (): UseQueryResult<GetCarBrandsResponseDTO, AxiosError> => {
...
export const useCarComparison = (
  ...
  return useQuery<GetCarComparisonResponseDTO, AxiosError>({
    ...
    enabled: enabled && !!params.brand && !!params.model && !!params.year && !!params.transmission && !!params.price && !!params.km,
  });
};
